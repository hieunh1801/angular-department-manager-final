...
public class ApartmentForm {
    ...
    private String name;
    private Long haveLive;
    private Long notHaveLive;
    
    public Long getHaveLive() {
		return haveLive;
	}

	public void setHaveLive(Long haveLive) {
		this.haveLive = haveLive;
	}

	public Long getNotHaveLive() {
		return notHaveLive;
	}

	public void setNotHaveLive(Long notHaveLive) {
		this.notHaveLive = notHaveLive;
	}
